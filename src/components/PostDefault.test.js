...
it("Renders PostDefault with input props values", () => {
	...
	expect(container.textContent).toBe("Title: Author: Vaccination Site: Date: Their Story: ");
	...
	expect(container.textContent).toBe("Title: My Vaccine ExperienceAuthor: John DoeVaccination Site: Kaiser Permanente in Roseville, CADate: 04/04/2021Their Story: My Experience was Pleasant");
});